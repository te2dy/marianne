 ...
 */
 ...
 if ( ! function_exists( 'marianne_customizer_scripts_styles' ) ) {
 	...
 	function marianne_customizer_scripts_styles() {
 		...
 		wp_enqueue_script( 'marianne-customizer', esc_url( get_template_directory_uri() . "/assets/js/customizer-controls$min.js" ), array( 'jquery', 'jquery-ui-slider', 'customize-preview' ), $theme_version );
 	}
